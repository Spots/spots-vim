...
1. cd to your home directory:
   ...
   cd ~
   ```
3. git clone this repo as your .vim folder:
...
5. install vundle:
   ...
   ``` 
7. symlink the vimrc file in it to your .vimrc:

       ```
   ln -s ~/.vim/vimrc ~/.vimrc
   ```
9. install the plugins(you will get an error about railscasts, just press enter):
